...
## Travailler via l'interface de l'application
...
## Travailler via un fichier YAML dans votre projet
...
→ [Référence complète du format YAML avec exemple commenté](/help/yaml-syntax)